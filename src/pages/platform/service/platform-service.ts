...
export const useGetAccounts = () =>
  useQuery<{ items: IAccount[] }, IAPIError>(
    [API_QUERY_KEY.GET_ALL_ACCOUNTS],
    async () => {
...
export const useCreateAccount = () => {
  ...
  return useMutation<{ account: IAccount; organization: IOrganization; ownerInvited: boolean }, IAPIError, ICreateAccountValue>(
    [API_MUTATION_KEY.CREATE_ACCOUNT],
    async (value) => {
    ...
    { onSuccess: () => queryClient.invalidateQueries([API_QUERY_KEY.GET_ALL_ACCOUNTS]) }
  );
};
...
export const useAddOrganizationToAccount = (accountId: string) => {
  ...
  return useMutation<IOrganization, IAPIError, IAddOrganizationToAccountValue>(
    [API_MUTATION_KEY.ADD_ORGANIZATION_TO_ACCOUNT],
    async (value) => {
...
export const useUpdateAccountStatus = () => {
  ...
  return useMutation<IAccount, IAPIError, { accountId: string; status: "active" | "trial" | "suspended" }>(
    [API_MUTATION_KEY.UPDATE_ACCOUNT_STATUS],
